    ...
    <div className="pt-16">
      <div className="container mx-auto pt-16 bg-black">
        <div className="text-center pb-3 md:pb-10 xl:pb-20">
          ...
          <h1 className="px-2 xl:px-0 xl:text-5xl md:text-3xl text-2xl font-extrabold text-gray-50">
          ...
          <ul>
            <li className="py-6 border-gray-200 border-solid border-b">
              <div className="flex justify-between items-center">
                <h3 className="text-gray-50 text-base  md:text-xl  xl:text-2xl w-10/12">
              ...
              {question === 0 && (
                <p className="pt-2 md:pt-3  lg:pt-5 text-gray-50 bg-black text-sm md:text-base  xl:text-lg rounded-b-lg">
                  Find the latest events updates or create events, concerts, conferences, workshops, exhibitions, and
                  cultural events in all cities of the US. The aim of Eventistan is to promote healthy and entertaining
                  event. Greatest appreciation to you and your team for the outstanding job you did for us. The website
                  is just what we wanted, and we were thrilled with the speed your team exercised.{' '}
                </p>
              )}
            </li>
            <li className="py-6 border-gray-200 border-solid border-b">
