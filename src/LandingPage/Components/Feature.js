...
//   return (
//     <>
//       <div className="mx-auto bg-black container f-f-p px-4 xl:px-0 py-24">
//         <h1 className="text-center text-3xl lg:text-5xl tracking-wider text-gray-50">How it works?</h1>
//         <div className="md:mt-24 f-f-p">
//           <div className="hidden md:flex justify-center w-full">
//             <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-50 relative md:w-1/2">
//               <svg
//                 className="mt-10"
...
//                 <h1 className=" text-white text-2xl tracking-wide font-semibold">Create a Wallet</h1>
//                 <h2 className="text-gray-50 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">
//                   Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                   Viverra sem ac, tellus viverra lacinia. Cras lacus.
//                 </h2>
//               </div>
//               <svg
//                 className="mt-24"
...
//                 <h1 className=" text-white text-2xl tracking-wide font-semibold">SignUp for an Account</h1>
//                 <h2 className="text-gray-50 mt-3 text-base leading-6 tracking-wide">
//                   Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                   Viverra sem ac, tellus viverra lacinia. Cras lacus.
//                 </h2>
//               </div>
...
//               </svg>
//               <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
//                 <h1 className="text-white text-2xl tracking-wide font-semibold">Start your Transactions</h1>
//                 <h2 className="text-gray-50 mt-3 text-base leading-6 tracking-wide">
//                   Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                   Viverra sem ac, tellus viverra lacinia. Cras lacus.
//                 </h2>
...
//             </svg>
//             <div className="mt-10">
//               <h1 className="text-white text-2xl text-center tracking-wide font-semibold">SignUp for an Account</h1>
//               <h2 className="text-gray-50 mt-3 text-center text-base leading-6 tracking-wide">
//                 Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                 Viverra sem ac, tellus viverra lacinia. Cras lacus.
//               </h2>
//             </div>
...
//             </svg>
//             <div className="mt-10">
//               <h1 className=" text-2xl tracking-wide text-white text-center font-semibold">Create a Wallet</h1>
//               <h2 className="text-gray-50 mt-3 pl-3 text-center text-base leading-6 tracking-wide">
//                 Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                 Viverra sem ac, tellus viverra lacinia. Cras lacus.
//               </h2>
//             </div>
...
//               />
//             </svg>
//             <div className="text-gray-50 flex mt-10 flex-col items-center md:items-start md:w-8/12">
//               <h1 className="text-white text-2xl text-center tracking-wide font-semibold">Start your Transactions</h1>
//               <h2 className="text-gray-50 mt-3 text-center text-base leading-6 tracking-wide">
//                 Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc.
//                 Viverra sem ac, tellus viverra lacinia. Cras lacus.
//               </h2>
