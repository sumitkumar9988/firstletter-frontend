      ...
      <section className="mx-auto container bg-black pt-16">
        <div className="px-4 lg:px-0">
          <div className="flex items-center flex-col px-4">
            ...
            <h2 className="text-4xl lg:text-5xl pt-4 font-extrabold text-center leading-tight text-white lg:w-7/12 md:w-9/12">
          ...
          <div className="mx-auto container flex flex-wrap px-2 md:px-24">
            <div className="flex sm:w-full md:w-1/2 lg:border-r md:border-r sm:border-r-0  pb-10 lg:pt-10">
              ...
              <div className="md:w-9/12 lg:w-9/12 mt-1">
                ...
                <p className="text-base text-white leading-normal xl:w-10/12 pt-2">
