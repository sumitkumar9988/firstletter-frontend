...
const Hero = () => {
  return (
    <div className="px-2 pt-32 bg-black md:px-0">
      <div className="container items-center max-w-6xl px-5 mx-auto space-y-6 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight text-left text-gray-50 sm:text-5xl md:text-6xl md:text-center">
          <span className="block">
            Create Your Own <span className="block mt-1 text-purple-500 lg:inline lg:mt-0">Portfolio Pages</span>
          </span>
        </h1>
