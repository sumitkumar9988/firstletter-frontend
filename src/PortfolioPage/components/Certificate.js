    ...
    <div className="text-white">
      <div class="pb-1 text-center text-gray-700 bg-black bg-cover">
        <div class="container relative max-w-2xl px-5 pt-12 mx-auto sm:py-12 lg:px-0">
          <h2 class="mb-10 text-2xl font-extrabold leading-10 tracking-tight text-left text-gray-900 sm:text-5xl sm:leading-none md:text-6xl sm:text-center">
            <span class="inline-block text-indigo-500">Certificates</span>
          </h2>
        </div>
