            ...
            <GoogleLogin
              ...
              render={(renderProps) => (
                ...
                <button
                  ...
                  role="button"
                  className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-50 py-3.5 px-4 border rounded-lg border-gray-50 flex items-center w-full mt-10"
                >
