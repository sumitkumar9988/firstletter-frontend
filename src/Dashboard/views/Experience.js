                  ...
                  <div className="slide-ana">
                    ...
                    >
                      <div className>
                        ...
                        <div className="py-6 border-b border-gray-200">
                          <h2 className="text-2xl text-indigo-500 font-bold">001</h2>
                    ...
                    >
                      <div className>
                        ...
                        <div className="py-6 border-b border-gray-200">
                          <h2 className="text-2xl text-indigo-500 font-bold">002</h2>
                          <p className="py-3 text-sm text-white leading-7">
                            Our mission is to help people visualize, create & maintain beautiful homes. We bring to you
                            inspiring visuals of cool homes and spaces.{' '}
                          </p>
...
//   </div>
//   <div className="py-6 border-b border-gray-200">
//     <h2 className="text-2xl text-indigo-500 font-bold">008</h2>
//     <p className="py-3 text-sm text-white leading-7">
//       Our mission is to help people visualize, create & maintain beautiful homes. We bring to you
//       inspiring visuals of cool homes and spaces.{' '}
//     </p>
...
//   </div>
//   <div className="py-6 border-b border-gray-200">
//     <h2 className="text-2xl text-indigo-500 font-bold">009</h2>
//     <p className="py-3 text-sm text-white leading-7">
//       Our mission is to help people visualize, create & maintain beautiful homes. We bring to you
//       inspiring visuals of cool homes and spaces.{' '}
//     </p>
