          ...
          <div className=" sm:w-1/2 w-full  flex flex-col items-center py-16 md:py-12 bg-gradient-to-r from-violet-300 to-violet-400">
            ...
            <div className="flex items-center mt-7">
              ...
              <div className="ml-12">
                ...
                <p className="mt-2 text-base sm:text-lg md:text-xl  text-gray-50">{data?.rating}</p>
              </div>
              <div className="ml-12">
                <p className="text-1xl text-gray-700">Total Contest</p>
                <p className="mt-2 text-base sm:text-lg md:text-xl text-gray-50">{data?.contests.length}</p>
              </div>
            </div>
          </div>
        </div>
