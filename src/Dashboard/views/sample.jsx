            ...
            <div className="lg:flex flex-wrap items-center">
              <div className="lg:w-1/3 w-full pb-6 md:pb-0 md:pr-6">
                <div className="w-full">
                  <h1 className="text-2xl lg:text-4xl font-bold text-indigo-500 tracking-wider lg:w-11/12 leading-relaxed">
                    New Events by Jesscia Geller
                  </h1>
                  <div className="py-4">
                  ...
                  <div className="slide-ana">
                                        ...
                                        >
                                            <div className>
                                                ...
                                                <div className="py-6 border-b border-gray-200">
                                                    <h2 className="text-2xl text-indigo-500 font-bold">Policy Level Decisions</h2>
                                                    <p className="py-3 text-sm text-white leading-7">Our mission is to help people visualize, create & maintain beautiful homes. We bring to you inspiring visuals of cool homes and spaces. </p>
                                                    <p className="text-sm text-red-600">Tuesday, 12th August, 2020</p>
                                                    <div className="pt-6">
                                                        <div className="flex justify-between w-full items-center text-gray-50 text-sm pl-2 pr-6">
                                                            <div className="flex items-center">
                                                                <div>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18" fill="none">
                                                                        <circle cx={9} cy={9} r="7.5" stroke="#fff" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                                                        <path d="M9 4.8335V9.00016L11.5 11.5002" stroke="#fff" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                                                    </svg>
                                                                </div>
                                                            ...
                                                            <div className="flex items-center pl-2">
                                                                <div>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} viewBox="0 0 16 18" fill="none">
                                                                        <circle cx={8} cy="8.1665" r="2.5" stroke="#fff" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                                                        <path fillRule="evenodd" clipRule="evenodd" d="M12.7141 12.8806L9.17831 16.4164C8.86602 16.729 8.44227 16.9047 8.0004 16.9047C7.55852 16.9047 7.13478 16.729 6.82248 16.4164L3.28581 12.8806C0.682416 10.2771 0.682489 6.05602 3.28597 3.45258C5.88946 0.84914 10.1105 0.84914 12.714 3.45258C15.3175 6.05602 15.3175 10.2771 12.7141 12.8806Z" stroke="#fff" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                                                    </svg>
                                                                </div>
                    ...
                    >
                      <div className>
                        ...
                        <div className="py-6 border-b border-gray-200">
                          <h2 className="text-2xl text-indigo-500 font-bold">Policy Level Decisions</h2>
                          <p className="py-3 text-sm text-white leading-7">
                            Our mission is to help people visualize, create & maintain beautiful homes. We bring to you
                            inspiring visuals of cool homes and spaces.{' '}
                          </p>
                          <p className="text-sm text-red-600">Tuesday, 12th August, 2020</p>
                          <div className="pt-6">
                            <div className="flex justify-between w-full items-center text-gray-50 text-sm pl-2 pr-6">
