    ...
    <>
      <div className="mx-auto container mt-0 lg:my-16 my-5 px-4 lg:px-0">
        <div className="lg:flex items-center justify-center mt-4 lg:mt-32">
          ...
          <div className="mt-4 lg:mt-0 py-12 px-8 lg:px-12 bg-gradient-to-r from-orange-400 to-rose-400 lg:w-2/5 lg:-ml-12 text-white f-f-l">
            <div className="lg:text-4xl text-2xl font-normal leading-9 pb-6 f-f-d-s">Your site</div>
            ...
            <div className="pb-6 leading-6 f-f-l text-base lg:text-2xl leading-9">
              Laborum laborum excepteur pariatur tempor elit reprehenderit aliquip.
            </div>
