...
function MyApp() {
    ...
    return (
      // new Dashboard Layout Testing
      <div className="flex flex-no-wrap">
        <div className="absolute border-r sm:relative h-full z-20">
          <div className="flex w-full">
            <div className="flex items-center justify-center flex-col w-full py-6 px-3 bg-gray-100 h-screen">
          ...
          <div className="2xl:p-20 p-4 w-full">
            <div className="w-full xl:flex items-center justify-between">
              <div className="2xl:w-1/2 w-full">
                <p className="2xl:text-6xl md:text-4xl text-3xl xl:mt-0 mt-4 font-bold leading-10 text-gray-100">
                  Purpose and Usage
                </p>
              ...
              <div className="w-full md:flex items-stretch 2xl:pt-0 pt-4">
                <div className="2xl:w-1/2 md:w-1/2 w-full border rounded border-gray-300 lg:px-16 px-8 md:py-10 py-5 mr-6">
                  ...
                  <p className=" text-base leading-6 pt-8 text-gray-50">
                    Real time traffice updates and suggested solutions that help you target the right people at the
                    right time
                  </p>
                  <div className="pt-8">
                    <div>
                ...
                <div className="2xl:w-1/2 md:w-1/2 w-full md:mt-0 mt-4 border rounded border-gray-300 lg:px-16 md:px-6 px-8 2xl:py-12 xl:py-7 md:py-12 py-5  ">
                  <p className=" text-2xl text-white font-bold leading-7">Identify core channels with OvonRueden</p>
                  <p className=" text-base leading-6 py-8 text-gray-50">
                    Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuad a.
                  </p>
