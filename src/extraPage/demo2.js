        ...
        <div className="flex flex-no-wrap">
            <div className="absolute border-r sm:relative h-full z-20">
                <div className="flex w-full">
                    <div
                        className="flex items-center justify-center flex-col w-full py-6 px-3 bg-gray-100 h-screen">
                        <svg
                            width={51}
                            height={32}
                            viewBox="0 0 51 32"
                        ...
                        <div aria-orientation="vertical" className="rounded py-10">
                            <button
                                className="cursor-pointer w-9 h-9 focus:bg-indigo-100 text-gray-500 focus:text-indigo-700 focus:ring-indigo-700 focus:ring-2 focus:ring-offset-2 focus:outline-none rounded flex items-center justify-center mb-4"
                    ...
                    {sidebar && (
                        <div
                            className="flex justify-start flex-col transition duration-150 ease-in-out bg-white">
                            ...
                            <ul aria-orientation="vertical" className="rounded py-7 mx-4">
                                ...
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-500">Statistics</span>
                                </li>
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-500">Favourites</span>
                                </li>
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-500">Workflows</span>
                                </li>
                            </ul>
                        </div>
                    )}
            ...
            <div className="2xl:p-20 p-4 w-full">
            <div className="w-full xl:flex items-center justify-between">
                <div className="2xl:w-1/2 w-full">
                    <p className="2xl:text-6xl md:text-4xl text-3xl xl:mt-0 mt-4 font-bold leading-10 text-gray-100">Purpose and Usage</p>
                    <p className="2xl:text-xl text-lg leading-normal text-gray-50 md:pt-10 pt-4 md:pr-24">
                        Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuada a, duis volutpat. Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuada a, duis volutpat. <br />
                        <br />
                ...
                <div className="w-full md:flex items-stretch 2xl:pt-0 pt-4">
                    <div className="2xl:w-1/2 md:w-1/2 w-full border rounded border-gray-300 lg:px-16 px-8 md:py-10 py-5 mr-6">
                        <p className="text-2xl text-white font-bold leading-7">Identify core channels with OvonRueden</p>
                        <p className=" text-base leading-6 pt-8 text-gray-50">Real time traffice updates and suggested solutions that help you target the right people at the right time</p>
                        <div className="pt-8">
                            <div>
                                <div className="flex items-center justify-between">
                                    <p className="w-72 text-sm leading-6 text-gray-50">Facebook</p>
                                    <p className="text-sm font-bold leading-6 text-gray-50">35,929</p>
                                </div>
                            ...
                            <div className="mt-6">
                                <div className="flex items-center justify-between">
                                    <p className="w-72 text-sm leading-6 text-gray-50">Twitter</p>
                                    <p className="text-sm font-bold leading-6 text-gray-50">65,929</p>
                                </div>
                            ...
                            <div className="mt-6">
                                <div className="flex items-center justify-between">
                                    <p className="w-72 text-sm leading-6 text-gray-50">Indie Hackers</p>
                                    <p className="text-sm font-bold leading-6 text-gray-50">5,929</p>
                                </div>
                                <div className="w-full h-1.5 mt-1.5">
                                    <div className="flex items-center justify-start h-full bg-gray-200 rounded-full">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center justify-between">
                                    <p className="w-72 text-sm leading-6 text-gray-50">Instagrams</p>
                                    <p className="text-sm font-bold leading-6 text-gray-50">52,929</p>
                                </div>
                                <div className="w-full h-1.5 mt-1.5">
                                    <div className="flex items-center justify-start h-full bg-gray-200 rounded-full">
                    ...
                    <div className="2xl:w-1/2 md:w-1/2 w-full md:mt-0 mt-4 border rounded border-gray-300 lg:px-16 md:px-6 px-8 2xl:py-12 xl:py-7 md:py-12 py-5  ">
                        <p className=" text-2xl text-white font-bold leading-7">Identify core channels with OvonRueden</p>
                        <p className=" text-base leading-6 py-8 text-gray-50">Convallis turpis erat tempus, viverra aliquet. Nullam viverra nam auctor sit ipsum malesuad a.</p>
                        <div className="flex items-center justify-center">
                            <img src="https://i.ibb.co/HghK2Mj/Chart.png" alt="chart image" className="2xl:h-56 h-52 w-56" />
                        </div>
                    </div>
                </div>
            </div>
